...
public class RSACoder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jimiBase64 = Base64.encodeBase64String(code1);
        System.out.println("加密后的数据：" + jimiBase64);
        System.out.println("===========乙方使用甲方提供的公钥对数据进行解密==============");
        //乙方进行数据的解密
        byte[] decode1 = RSACoder.decryptByPublicKey(Base64.decodeBase64(jimiBase64.getBytes()), publicKey);
